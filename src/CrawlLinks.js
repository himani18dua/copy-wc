...
function CrawlLinks() {
    ...
    const handleCrawl = async () => {
        ...
        try {
            const response = await fetch('https://cors-anywhere.herokuapp.com/https://fin-back-odw1.onrender.com/crawl', {
                method: 'POST',
                headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch("https://cors-anywhere.herokuapp.com/https://fin-back-odw1.onrender.com/members");
            if (!response.ok) {
    ...
    const handleDownload = () => {
        fetch('https://cors-anywhere.herokuapp.com/https://fin-back-odw1.onrender.com/download')
