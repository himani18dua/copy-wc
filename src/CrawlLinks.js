...
function CrawlLinks() {
    ...
    const handleCrawl = async () => {
        ...
        try {
            const response = await fetch('https://flask-sample-ff32.onrender.com/crawl', {
                method: 'POST',
                headers: {
    ...
    const fetchData = async () => {
        try {
            const response = await fetch("https://flask-sample-ff32.onrender.com/members");
            if (!response.ok) {
    ...
    const handleDownload = () => {
        fetch('https://flask-sample-ff32.onrender.com/download')
